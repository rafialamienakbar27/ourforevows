...
const steps = [
  {
    num: "01",
    title: "Ngobrol Dulu",
    desc: "Kita kenalan dulu, cerita momen apa yang mau diabadiin — proposal, ultah, wedding, atau event lainnya.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  {
    num: "02",
    title: "Siapkan Konsep",
    desc: "Kita susun bareng — vibe, gaya konten, timeline hari H. Biar semua berjalan smooth dan hasilnya sesuai ekspektasi kamu.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    num: "03",
    title: "Hari H",
    desc: "Kami datang, kamu fokus nikmatin momennya. Setiap tawa, setiap momen tak terduga, semua detail kecil — kami yang urus.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    num: "04",
    title: "Editing & Kirim",
    desc: "Kontennya kami edit secara profesional serta dikirim tepat waktu. Tinggal posting, dan momen itu jadi milik kamu selamanya.",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
...
export default function Process() {
  ...
  return (
    <section
      id="process"
      className="py-28 px-[4vw] bg-[var(--green-deep)] relative overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <p
          ref={ref}
          className="text-[0.72rem] tracking-[0.22em] uppercase text-[var(--green-light)] mb-8"
        >
          PROCESS
        </p>
