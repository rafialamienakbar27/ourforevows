...
const defaultTestimonials: Testimonial[] = [
  {
    initials: "K&A",
    name: "Kania & Aji",
    event: "Wedding · Villa Annisa, Ciparay",
    text: "Kontennya aesthetic banget kak, kekinian, dan cepet jadinya juga! Behind the scene, reels, video, sampe moment candid semuanya dapet. Terbantu banget, makasii banyak yaaa!",
  },
  {
    initials: "A&R",
    name: "Aulia & Rifky",
    event: "Wedding · Andir, Bandung",
    text: "Sukak banget sama hasilnya, bener-bener memuaskan! Dari awal sampai akhir semuanya lancar dan hasilnya di luar ekspektasi. Semoga next time bisa abadikan momen bareng kakak lagi ya, makasih banyak!",
  },
];
    ...
    >
      ...
      <div className="mb-5">
        <svg width="32" height="24" viewBox="0 0 32 24" fill="none">
          <path
            d="M0 24V14.4C0 10.08 1.12 6.56 3.36 3.84 5.6 1.12 8.96 0 13.44 0v3.84c-2.56 0-4.48.8-5.76 2.4C6.4 7.84 5.76 9.92 5.76 12.48H10.88V24H0ZM18.56 24V14.4c0-4.32 1.12-7.84 3.36-10.56C24.16 1.12 27.52 0 32 0v3.84c-2.56 0-4.48.8-5.76 2.4-1.28 1.6-1.92 3.68-1.92 6.24H29.44V24H18.56Z"
            fill="#2D6A2D"
            fillOpacity="0.12"
          />
        </svg>
      ...
      <div className="flex items-center gap-4 pt-6 border-t border-[var(--beige)]/60">
        ...
        <div>
          <strong className="block text-[0.9rem] font-medium text-[var(--text-dark)]">
            {t.name}
          </strong>
          <span className="text-[0.72rem] text-[var(--text-light)] font-light">
            {t.event}
          </span>
        </div>
        {/* Star rating */}
...
export default function Testimonials({ data }: { data?: Testimonial[] }) {
  ...
  return (
    <section
      id="testimonials"
      className="py-28 px-[4vw] bg-[var(--cream)] relative overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <p
          ref={ref}
          className="text-[0.72rem] tracking-[0.22em] uppercase text-[var(--green-main)] mb-8"
        >
          TESTIMONIALS
        </p>
